(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".contain_some__swiper")) new swiper_core_Swiper(".contain_some__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".content-some__arrow-left",
                nextEl: ".content-some__arrow-right"
            },
            on: {}
        });
    }
